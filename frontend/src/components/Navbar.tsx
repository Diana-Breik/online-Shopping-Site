            ...
            <div className={menuToggel ? 'navbar active' : 'navbar'}>
                <ul className={'nav-menu'}>
                    <li className={'nav-item'}>
                        <Link to={`/`}
                              className="navText">Home</Link> {/*am besten benutzt man da <Link> / <NavLink> oder useNavigate()*/}
                    </li>
                    <li className={'nav-item'}>
                        <Link to={`/products`} className="navText" onClick={props.handleClick}>Products</Link>
                    </li>
                    <li className={'nav-item'}>
